            ...
            <main className="flex-grow pt-24 px-6">
                <div className="mx-auto max-w-7xl">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl mb-12">
                        Connect Simplu with your favorite tools to streamline your workflow.
                    </p>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        ...
                        <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm">
                            ...
                            <p className="text-sm text-muted-foreground">Sync your appointments and schedule.</p>
                        </div>
                        <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm">
                            <h3 className="font-semibold text-lg mb-2">Slack</h3>
                            <p className="text-sm text-muted-foreground">Get notifications and updates in your team chat.</p>
                        </div>
                        <div className="p-6 rounded-xl border bg-card text-card-foreground shadow-sm">
