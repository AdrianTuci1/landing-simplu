...
export const Cta4 = ({
  ...
  return (
    (<section className="relative flex h-full items-stretch bg-gray-100">
      ...
      <div
        className="pointer-events-none absolute top-0 left-0 right-0 h-px bg-border z-30"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute bottom-0 left-0 right-0 h-px bg-border z-30"
        aria-hidden
      />
      ...
      <div
        className="pointer-events-none absolute inset-y-0 left-[153px] z-20 w-0 border-l border-dashed border-border/80 z-30"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute inset-y-0 right-[153px] w-0 border-r border-dashed border-border/80 z-30"
        aria-hidden
      />
      {/* Borduri orizontale dashed */}
      <div
        className="pointer-events-none absolute h-0 border-t border-b border-border/80 z-30"
        aria-hidden
      />
      <div
        className="pointer-events-none absolute left-[40px] right-[40px] bottom-[calc(5%-18px)] h-0 border-b border-dashed border-border/80 z-30"
        aria-hidden
      />
      {/* Conținut */}
